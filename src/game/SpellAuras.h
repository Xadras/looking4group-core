 ...
 */
#ifndef lOOKING4GROUP_SPELLAURAS_H
#define lOOKING4GROUP_SPELLAURAS_H
...
class lOOKING4GROUP_IMPORT_EXPORT Aura
{
...
class lOOKING4GROUP_IMPORT_EXPORT AreaAura : public Aura
{
    public:
...
class lOOKING4GROUP_IMPORT_EXPORT PersistentAreaAura : public Aura
{
    public:
