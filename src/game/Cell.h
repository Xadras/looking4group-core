...
struct Cell
{
    public:
        ...
        {
            return CellPair(data.Part.grid_x*MAX_NUMBER_OF_CELLS+data.Part.cell_x,
    ...
    private:
        ...
        void VisitCircle(TypeContainerVisitor<T, CONTAINER> &, Map &, const CellPair& , const CellPair&) const;
};
