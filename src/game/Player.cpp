...
/* Wieso machen wir den Quatch eigentlich???
    for (uint16 i = 23; i < 39; i++) //Alles l�schen, bis auf EQ und Taschen - Nun auch nichts mehr auf der Bank ;)
    {
        DestroyItem(255, i, true);
    }
    uint16 d = 19; //19 entspricht der ersten Tasche nach dem nicht l�schbaren Rucksack
    ...
    if(getClass()!= CLASS_HUNTER) //Nur bei nicht huntern die ersten 3 Tascheninhalte leeren
    {
        for (uint16 i = 0; i < 24;i++)  //i = 24 entspricht der maximalen bekannten taschenslotzahl
        {
            ...
            if (i == 23 && d < INVENTORY_SLOT_BAG_3) //Die ersten 3 zus�tzlichen Taschen leeren (Bei Bedarf auch die 4., dazu INVENTORY_SLOT_BAG_3 anpassen.
            {
                i = 0;
                d++;
            }
    ...
    {
        d = 20; //20 entspricht der zweiten Tasche nach dem nicht l�schbaren Rucksack
        for (uint16 i = 0; i < 24 ;i++)  //i = 24 entspricht der maximalen bekannten taschenslotzahl
        {
            DestroyItem(d, i, true);
            if (i == 23 && d < INVENTORY_SLOT_BAG_4) //Die 2. bis 4. zus�tzlichen Taschen leeren (Bei Bedarf auch die 4., dazu INVENTORY_SLOT_BAG_3 anpassen.
            {
                i = 0;
                d++;
            }
